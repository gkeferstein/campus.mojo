...
import { BookOpen, Clock, TrendingUp, LogOut, User } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      <header className="border-b border-border bg-background/80 backdrop-blur-md sticky top-0 z-30">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl">MOJO Campus</span>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
              ...
              {enrolledCourses.map((course, index) => (
                ...
                >
                  <Link href={`/courses/${course.slug}`}>
                    <Card className="bg-card/50 hover:bg-card transition-all hover:shadow-lg hover:shadow-primary/5 group cursor-pointer h-full">
                      <CardHeader>
        ...
        {!isLoading && courses.length === 0 && (
          <Card className="bg-card/50 text-center p-12">
